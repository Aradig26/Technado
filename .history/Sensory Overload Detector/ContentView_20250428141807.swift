...
struct ContentView: View {
        ...
        return VStack(spacing: 10) {
            ...
            HStack {
                ...
                VStack(alignment: .leading) {
                    ...
                    Text(isOverload ? "Environmental conditions may cause sensory discomfort" : "Current conditions appear safe")
                        .font(.caption)
                }
    ...
    private var settingsView: some View {
        NavigationStack {
            Form {
                if let currentSettings = settings.first {
                    Section(header: Text("Sound Threshold"), footer: Text("The sound level (in decibels) which may contribute to sensory discomfort. Normal conversation is around 60dB, and loud environments are 80dB+.")) {
                    ...
                    Section(header: Text("Light Threshold"), footer: Text("The light level (in lux) which may contribute to sensory discomfort. Indoor lighting is typically 300-500 lux, and bright offices are around 1000 lux.")) {
                        VStack(alignment: .leading, spacing: 10) {
                            HStack {
                    ...
                    Section(header: Text("Notifications"), footer: Text("When enabled, you'll receive alerts when the app detects a potential discomfort situation.")) {
